                        ...
                        child: Column(children: <Widget>[
                          ...
                          Row(
                            children: [
                              Padding(
                                ...
                                child: FaIcon(FontAwesomeIcons.portrait,
                                    size: 27.0, color: brightTextColor),
                              ),
                              SizedBox(width: 8.0),
                              Expanded(
                                child: formTextInput('Логин',
                                    usernameController, context, false),
                              )
                            ],
                          ),
                          SizedBox(height: 20.0),
                          Row(
                            children: [
                              ...
                              SizedBox(width: 8.0),
                              Expanded(
                                child: formTextInput('Пароль',
                                    passwordController, context, true),
                              ),
                            ],
                          ),
                          SizedBox(height: 20.0),
