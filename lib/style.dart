...
const primaryColor = Color(0xFFe5e1dd);
const secondaryColor = Color(0xFF383C40);
const bgColor = Color(0xFF272d33);
const splashColor = Color(0xFFd8d5d2);
const disabledColor = Color(0xFFE5E5E5);
const defaultTextColor = bgColor;
const brightTextColor = primaryColor;
...
const defaultTextStyle = TextStyle(
    color: brightTextColor, fontSize: 16.0, fontWeight: FontWeight.normal);
